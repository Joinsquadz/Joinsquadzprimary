...
const SEED_EVENTS = [
  {
    ...
    hostId: "u1",
    description: "Annual rooftop BBQ! Bring your A-game grilling skills.",
    inviteCode: "BBQ-7K2M",
    cancelled: false,
    rsvps: { u1: "going", u2: "going", u3: "going", u4: "going", me: "going", u5: "maybe" },
    tasks: [
    ...
    costs: [
      { id: "c1", description: "Meat & veggies", amount: 85, paidById: "u1", shares: [{ userId: "me", amount: 17 }, { userId: "u1", amount: 17 }, { userId: "u2", amount: 17 }, { userId: "u3", amount: 17 }, { userId: "u4", amount: 17 }] },
      { id: "c2", description: "Drinks", amount: 45, paidById: "me", shares: [{ userId: "me", amount: 9 }, { userId: "u1", amount: 9 }, { userId: "u2", amount: 9 }, { userId: "u3", amount: 9 }, { userId: "u4", amount: 9 }] },
    ],
    polls: [
      { id: "p1", question: "What time should we fire up the grill?", options: [{ id: "po1", label: "5:00 PM", voterIds: ["u1", "u2"] }, { id: "po2", label: "6:00 PM", voterIds: ["u3"] }, { id: "po3", label: "7:00 PM", voterIds: [] }] },
    ],
    messages: [
  ...
  },
  {
    ...
    squadName: "The Usual Suspects",
    hostId: "me",
    description: "Mario Kart tournament night! Winner gets bragging rights.",
    inviteCode: "GAME-4X9Z",
    cancelled: false,
    rsvps: { u1: "going", u3: "going", me: "going", u2: "maybe" },
    tasks: [
    ...
    costs: [],
    polls: [],
    messages: [{ id: "m4", senderId: "u1", text: "Mario Kart or Smash first?", time: "3h ago" }],
  },
  {
    id: "e3",
    emoji: "🏖️",
    ...
    inviteCode: "BCH-2WQY",
    cancelled: false,
    rsvps: { u2: "going", u3: "going", me: "going" },
    tasks: [
      { id: "t6", title: "Bring sunscreen", assigneeId: "me", done: false },
      { id: "t7", title: "Pack volleyball", assigneeId: "u3", done: false },
    ],
    costs: [{ id: "c3", description: "Parking", amount: 20, paidById: "u2", shares: [{ userId: "me", amount: 6.67 }, { userId: "u2", amount: 6.66 }, { userId: "u3", amount: 6.67 }] }],
    polls: [],
    messages: [],
  },
  {
    ...
    cancelled: false,
    rsvps: { u1: "going", u4: "going", me: "going" },
...
async function seedIfEmpty() {
  ...
  if (existing.length === 0) {
    ...
    await db.insert(eventsTable).values(SEED_EVENTS as any).onConflictDoNothing();
  }
  seeded = true;
}
